...
public class BaseConversion { 
	...
	int place1; // digit in the base^1 place int place2;
	// digit in the base^2 place int place3;
	...
	System.out.println(); System.out.println ("Base Conversion Program");
	System.out.println() ; System.out.print ("Please enter a base (2-9): ");
	base = scan.nextInt(); 
